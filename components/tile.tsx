import { useRef, useContext, createContext, FC, ReactNode } from 'react'
...
export const TileWrapper: FC<WrapperProps> = ({
    children, numOfPages
}) => {
...
export const TileBackground: FC<ChildeProps> = ({ children }) => (
    <div className="absolute h-full w-full" > {children}</div >
)

export const TileContent: FC<ChildeProps> = ({ children }) => (
